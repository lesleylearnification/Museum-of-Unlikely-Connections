...
function specimenMarkup(item,compact=false){
  ...
  return `<div class="specimen ${compact?'compact':''}" role="img" aria-label="${escapeHtml(item.name)} antique museum specimen">
    <div class="specimen-dust"></div>
    <div class="specimen-glare"></div>
    <div class="specimen-object" aria-hidden="true">${icon}</div>
    <div class="specimen-plinth"><span>${symbol}</span></div>
